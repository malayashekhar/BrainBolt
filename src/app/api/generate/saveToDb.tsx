import { db } from '@/db'
import { quizs, questions as dbQuestions, questionAnswers } from '@/db/schema'
import { InferInsertModel } from 'drizzle-orm';
import { auth } from '@/auth';

type Quiz = InferInsertModel<typeof quizs>;
...
export default async function saveQuiz(quizData: SaveQuizData) {
    ...
    const newQuiz = await db.insert(quizs).values({
        name,
        description,
        userId: id,
    }).returning({ insertedId: quizs.id });
